export default function RulesPage({ data }) {
    ...
    return (
        <div className='flex flex-col gap-4 md:gap-6 lg:gap-8 w-full text-[--color-texts] bg-[--color-secondary] px-14 py-12'>
            {rules.map((rule, index) => (
                <div key={index} className='flex flex-col gap-1 pl-8'>
